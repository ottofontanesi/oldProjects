...
This folder contains icon assets for ResonantOS.
...
They are standalone SVG files, so opening any file directly should show the icon.
...
Use Tabler as the primary product UI/action icon set. Use Lucide or Heroicons only when they provide a better specific shape. Use Simple Icons for recognizable third-party brands. Prefer the custom set for ResonantOS-specific product concepts.
