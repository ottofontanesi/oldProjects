...
mod archive_service;
mod experience_buffer_service;
mod backtest_service;
mod browser_host_service;
mod browser_native_service;
mod browser_service;
mod compute_service;
mod config_validator_service;
mod cost_ledger_service;
mod delegation_service;
mod federated_memory_service;
mod hardware_gpu_detection;
mod hardware_resource_manager;
mod hardware_service;
mod hardware_thermal;
mod hardware_timeout_runtime;
mod hardware_vram_manager;
mod health_monitor;
mod hermes_service;
mod host_state;
mod memory_service;
...
pub mod schema_migration_registry;
pub mod agents;
pub mod network;
pub mod transport;
pub mod inference;
...
mod tool_call_analysis;
mod tool_call_sanitizer;
mod tool_call_tracker_service;
mod reticulum_channel_service;
mod agent_evaluator_service;
// TODO: fix test compilation errors in legacy test modules
// #[cfg(test)]
// mod reticulum_channel_proptest;
mod rl_inference_service;

// #[cfg(test)]
// mod hardware_tests;

// #[cfg(test)]
// mod data_infrastructure_integration_tests;
...
use crate::browser_native_service::{
    prepare_native_browser_application_if_available,
...
use crate::backtest_service::backtest_execute_suite;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cost_ledger_service::cost_ledger_record,
            cost_ledger_service::cost_ledger_query,
            cost_ledger_service::cost_ledger_projection,
            federated_memory_service::federated_memory_write_cmd,
            federated_memory_service::federated_memory_query_cmd,
            federated_memory_service::federated_memory_read_by_id_cmd,
            federated_memory_service::federated_memory_status_cmd,
            backtest_execute_suite,
            tool_call_tracker_service::tool_call_tracker_query_records,
            tool_call_tracker_service::tool_call_tracker_query_analysis,
            tool_call_tracker_service::tool_call_tracker_query_anomalies,
            tool_call_tracker_service::tool_call_tracker_export,
            tool_call_tracker_service::tool_call_tracker_config_read,
            tool_call_tracker_service::tool_call_tracker_config_update,
            tool_call_tracker_service::tool_call_tracker_status
        ])
