...
/** Per-route probe state maintained by the Health Monitor. */
...
/** Emitted when degradation is detected on a provider route. */
...
/** Pre-aggregated daily/weekly summary for fast dashboard queries. */
