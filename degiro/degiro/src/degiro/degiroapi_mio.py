...
"""
https://www.reddit.com/r/DEGIRO/comments/ze8xz7/unoffical_degiroapi_not_working_anymore/
https://github.com/lolokraus/DegiroAPI/blob/a2fe1c0819404ec55c08a7ac4a2a8074101aaf4b/degiroapi/__init__.py#L71
...
class DeGiro:
    ...
    @staticmethod
    def __request(url, cookie=None, payload=None, headers=None, data=None, post_params=None,
                  request_type=__GET_REQUEST, error_message='An error occurred.'):
    ...
    def buyorder(self, orderType, productId, timeType, size, limit=None, stop_loss=None):
        ...
        if orderType not in (Order.Type.STOPLIMIT, Order.Type.MARKET, Order.Type.LIMIT, Order.Type.STOPLOSS):
            raise Exception('Invalid order type')

        if timeType not in (1, 3):
    ...
    def get_stock_list(self, indexId, stockCountryId):
        ...
        return self.__request(DeGiro.__GET_STOCKS_URL, None, stock_list_params,
